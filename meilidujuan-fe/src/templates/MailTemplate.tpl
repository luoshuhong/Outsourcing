<table cellpadding="0" cellspacing="0" width="650" align="center" style="font-size:14px; font-family:'Helvetic Neue', Helvetica, Arial; background-color:#fff;">
    ...
    <tr height="60" align="left">
        <td style="font-size:24px; font-family:'Helvetic Neue', Helvetica, Arial;padding-left: 30px; padding-top:25px;color:#333;font-weight:bold">
            恭喜您，收到了一封新的订单！
        </td>
    </tr>
    <tr>
        <td style="font-size:14px; font-family:'Helvetic Neue', Helvetica, Arial;padding-left: 30px;padding-top:15px;color:#333;">
            您的朋友 <%=name%> 来自<%=address%>qq: <%=qq%>，期望与您联系：
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="font-size:14px; font-family:'Helvetic Neue', Helvetica, Arial;padding-left: 30px;color:#333;">
            如果不能点击，可以将URL复制粘贴到浏览器地址栏直接访问。
        </td>
    </tr>
    <tr>
